...
<form method=post>
<p>
This script will take the name that you give and create an LibreEHR database with this as the database name, username, password, group name.  It will also rename the directory this LibreEHR installation is under to the new name.  THIS ONLY WORKS WITH XAMPP AND HAS VERY LIMITED TESTING.
</p>
<p>
...
<p>
Enter the name you wish to use for this LibreEHR installation.
</p>
