...
<TR VALIGN='TOP'><TD><span class='text'>Database Name: </span></TD><TD><INPUT TYPE='TEXT' VALUE='LibreHealth EHR' NAME='dbname' SIZE='30'></TD><TD><span class='text'>(This is the name of the LibreHealth EHR database in MySQL - 'LibreHealth EHR' is the recommended)</span><br></TD></TR>
<TR VALIGN='TOP'><TD><span class='text'>Login Name: </span></TD><TD><INPUT TYPE='TEXT' VALUE='LibreHealth EHR' NAME='login' SIZE='30'></TD><TD><span class='text'>(This is the name of the LibreHealth EHR login name in MySQL - 'LibreHealth EHR' is the recommended)</span><br></TD></TR>
