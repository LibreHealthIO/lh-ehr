          ...
          $sortby = $_REQUEST['sortby'];
           ...
           switch ($srch_option) {
              ...
              for($i = 0; $i < count($sort); $i++) {
                    $sortlink[$i] = "<a href=\"#\" onclick=\"sortingCols('$sort[$i]','asc');\" ><img src=\"../../assets/images/sortdown.gif\" border=0 alt=\"".xla('Sort Up')."\"></a>";
              }
              for($i = 0; $i < count($sort); $i++) {
                  if($sortby == $sort[$i]) {
                      switch($sortorder) {
                  case "asc"      :
                      $sortlink[$i] = "<a href=\"#\" onclick=\"sortingCols('$sortby','desc');\" ><img src=\"../../assets/images/sortup.gif\" border=0 alt=\"" . htmlspecialchars(xl('Sort Up'),
                              ENT_QUOTES) . "\"></a>";
                      break;
                  case "desc"     :
                      $sortlink[$i] = "<a href=\"#\" onclick=\"sortingCols('$sortby','asc');\" onclick=\"top.restoreSession()\"><img src=\"../../assets/images/sortdown.gif\" border=0 alt=\"" . xla('Sort Down') . "\"></a>";
                      break;
              }
              break;
                  }
