...
`Pain_rating`						tinyint(4)				default 0,
...
`GCS_bestVerbal`					tinyint(4)				default 0,
`GCS_bestMotor`						tinyint(4)				default 0,
`GCS_total`							tinyint(4)				default 0,
...
`msk_gcircum`						tinyint(4)				default 0,
