...
function button_ros_report( $pid, $encounter, $cols, $id) {
    ...
    echo "<br><br>". xlt('EYES')." <br>";
    if ($patient_reports !==xlt('Patient Reports')) {echo $patient_reports."<br>";}
    if ($patient_denies !==xlt('Patient Denies')) {echo $patient_denies;}
    if ($obj{"EYES_notes"} ){echo "<br>". xlt('Notes').":  ".$obj{"EYES_notes"};} 
    ...
    echo "<br><br>". xlt('ENT')." <br>";
    if ($patient_reports !==xlt('Patient Reports')) {echo $patient_reports."<br>";}
    if ($patient_denies !==xlt('Patient Denies')) {echo $patient_denies;}
    if ($obj{"ENT_notes"}){echo "<br>". xlt('Notes').":  ".$obj{"ENT_notes"};} 
    ...
    echo "<br><br>". xlt('RESP')." <br>";
    if ($patient_reports !==xlt('Patient Reports')) {echo $patient_reports."<br>";}
    if ($patient_denies !==xlt('Patient Denies')) {echo $patient_denies;}
    if ($obj{"RESP_notes"}){echo "<br>". xlt('Notes').":  ".$obj{"RESP_notes"};} 
    ...
    echo "<br><br>". xlt('CVS')." <br>";
    if ($patient_reports !==xlt('Patient Reports')) {echo $patient_reports."<br>";}
    if ($patient_denies !==xlt('Patient Denies')) {echo $patient_denies;}
    if ($obj{"CVS_notes"}){echo "<br>". xlt('Notes').":  ".$obj{"CVS_notes"};} 
    ...
    echo "<br><br>". xlt('GI')." <br>";
    if ($patient_reports !==xlt('Patient Reports')) {echo $patient_reports."<br>";}
    if ($patient_denies !==xlt('Patient Denies')) {echo $patient_denies;}
    if ($obj{"GI_notes"}){echo "<br>". xlt('Notes').":  ".$obj{"GI_notes"};} 
    ...
    echo "<br><br>". xlt('GU')." <br>";
    if ($patient_reports !==xlt('Patient Reports')) {echo $patient_reports."<br>";}
    if ($patient_denies !==xlt('Patient Denies')) {echo $patient_denies;}
    if ($obj{"GU_notes"}){echo "<br>". xlt('Notes').":  ".$obj{"GU_notes"};} 
    ...
    echo "<br><br>". xlt('MSK')." <br>";
    if ($patient_reports !==xlt('Patient Reports')) {echo $patient_reports."<br>";}
    if ($patient_denies !==xlt('Patient Denies')) {echo $patient_denies;}
    if ($obj{"MSK_notes"}){echo "<br>". xlt('Notes').":  ".$obj{"MSK_notes"};} 
    ...
    echo "<br><br>". xlt('NEURO')." <br>";
    if ($patient_reports !==xlt('Patient Reports')) {echo $patient_reports."<br>";}
    if ($patient_denies !==xlt('Patient Denies')) {echo $patient_denies;}
    if ($obj{"NEURO_notes"} ){echo "<br>". xlt('Notes').":  ".$obj{"NEURO_notes"};} 
    ...
    echo "<br><br>". xlt('HEME')." <br>";
    if ($patient_reports !==xlt('Patient Reports')) {echo $patient_reports."<br>";}
    if ($patient_denies !==xlt('Patient Denies')) {echo $patient_denies;}
    if ($obj{"HEME_notes"} ){echo "<br>". xlt('Notes').":  ".$obj{"HEME_notes"};} 
    ...
    echo "<br><br>". xlt('ENDO')." <br>";
    if ($patient_reports !==xlt('Patient Reports')) {echo $patient_reports."<br>";}
    if ($patient_denies !==xlt('Patient Denies')) {echo $patient_denies;}
    if ($obj{"ENDO_notes"} ){echo "<br>". xlt('Notes').":  ".$obj{"ENDO_notes"};} 
    ...
    echo "<br><br>". xlt('DERM')." <br>";
    if ($patient_reports !==xlt('Patient Reports')) {echo $patient_reports."<br>";}
    if ($patient_denies !==xlt('Patient Denies')) {echo $patient_denies;}
    if ($obj{"DERM_notes"}){echo "<br>". xlt('Notes').":  ".$obj{"DERM_notes"};}
     echo"<BR><BR>";
