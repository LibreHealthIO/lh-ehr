...
{
 alert("<?php echo xl('De-identification files will be saved in'); echo ' `'.$GLOBALS['temporary_files_dir'].'` '; echo xl('location of the libreehr machine and may contain sensitive data, so it is recommended to manually delete the files after its use');?>");
