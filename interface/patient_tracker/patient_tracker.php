...
<div id="pat_settings" class="well collapse">
    <form method='post' name='pt_settings' id="pt_settings" action='<?php echo $action_page; ?>'>
        <!--<div class="checkbox">
        <label><input type="checkbox" id="ptkr_pt_list_new_window" name="ptkr_pt_list_new_window" value="1" <?php //($GLOBALS['ptkr_pt_list_new_window']=='1') echo "checked"; ?>><?php //echo xlt("Open Demographics in New Window from Patient Flow Board"); ?></label>
        </div>-->
        <div class="checkbox">
