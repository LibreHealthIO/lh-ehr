 ...
 */
 ...
 $primary_docs = array(
  ...
  'nen' => array(xl('Create Visit'), 1, 'forms/patient_encounter/new.php?autoloaded=1&calenc='),
...
function clearactive() {
 ...
 function setPatient(pname, pid, pubpid, frname, str_dob) {
  var str = '<a href=\'javascript:;\' onclick="parent.left_nav.loadCurrentPatientFromTitle()" title="PID = ' + pid + '"><b>' + pname + ' (' + pid + ')<br /></b></a>';
...
<?php do_action( 'left_nav_before_html_end' ); ?>
</html>
