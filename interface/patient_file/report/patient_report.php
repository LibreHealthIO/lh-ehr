...
<html>
  <head>
    ...
    <?php
      call_required_libraries(array('jquery-min-1-7-2', 'jquery-ui'));
    ?>
    ...
    <div id="patient_reports">
      ...
      <div id="ccr_report">
        ...
        <form name='ccr_form' id='ccr_form' method='post' action='../../../ccr/createCCR.php'>
          ...
          <input type="checkbox" name="show_date" id="show_date" onchange="show_date_fun();"/>
          <span class='text'><?php xl('Use Date Range','e'); ?></span>
          <br>
