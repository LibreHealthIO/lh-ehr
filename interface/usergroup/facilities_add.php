...
<html>
  <head>
    <?php
        call_required_libraries(array('fancybox', 'jquery-min-3-1-1', 'common', 'jquery-ui'));
    ?>
    ...
    <form name='facility' method='post' action="facilities.php" target='_parent'>
      ...
      <table border=0 cellpadding=0 cellspacing=0>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>
            <span class="text"><?php echo xlt('Phone'); ?>: </span>
          </td>
          <td><input type=entry name=phone size=20 value="">
          </td>
        </tr>
        <tr>
          <td>
