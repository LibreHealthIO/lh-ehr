        ...
        <form class="section" id="acl_add_form" action="no_javascript" method="post">
          ...
          <table>
            <tr>
              ...
              <td><span class="alert" id="title_error"></span></td>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td><span class="alert" id="identifier_error"></span></td>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <select id="return_field"></select>
              <td><span class="alert" id="return_error"></span></td>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <input type="text" id="desc_field">
              <td><span class="alert" id="description_error"></span></td>
              </td>
            </tr>
          </table>
        ...
        <form class="section" id="acl_remove_form" action="no_javascript" method="post">
          ...
          <table>
            <tr>
              ...
              <td>
                <select id="acl_field"></select>
              <td><span class="alert" id="aclTitle_error"></span></td>
              </td>
            </tr>
            <tr>
              <td>
