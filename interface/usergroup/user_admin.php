    ...
    <FORM NAME="user_form" METHOD="POST" ACTION="usergroup_admin.php" target="_parent" onsubmit='return top.restoreSession()'>
      ...
      <TABLE border=0 cellpadding=0 cellspacing=0>
        ...
        <tr>
          ...
          <td><input type=entry name=suffix id=suffix style="width:150px;"  title ="<?php echo xla("Please Change this Information in the Address Book"); ?>" value="<?php echo $iter["suffix"]; ?>" readonly> </td>
        ...
        <TR>
          ...
          <TD><input type=entry name=taxid style="width:150px;"  value="<?php echo $iter["federaltaxid"]?>"></td>
          <TD><span class=text><?php echo xlt('DEA Number'); ?>: </span></TD>
          <TD><input type=entry name=drugid style="width:150px;"  value="<?php echo $iter["federaldrugid"]?>"></td>
        </TR>
        <tr>
        ...
        <tr>
          ...
          <td><input type="entry" name="npi" style="width:150px;"  value="<?php echo $iter["npi"]?>"></td>
          <td><span class="text"><?php echo xlt('Job Description'); ?>: </span></td>
          <td><input type="entry" name="job" style="width:150px;"  value="<?php echo $iter["specialty"]?>"></td>
        </tr>
        <!-- (CHEMED) Calendar UI preference -->
        <tr>
          ...
          <td><select name="cal_ui" style="width:150px;" >
            <?php
