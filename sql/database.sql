...
(4, 'SMS', 'SENT', 'SMS Sent, not read - in process', '<span class="btn" title="SMS Sent - in process" style="background-color:yellow;color:black;"><i class="fa fa-commenting-o fa-fw"></i></span>', ''),
(5, 'SMS', 'READ', 'SMS delivered/read', '<span class="btn" title="SMS Sent and Read - waiting for response" aria-label="SMS Delivered" style="background-color:#146abd;"><i class="fa fa-commenting-o fa-flip-horizontal fa-fw" aria-hidden="true"></i></span>', ''),
(6, 'SMS', 'FAILURE', 'SMS delivery failed', '<span class="btn" title="SMS Failed to be delivered" style="background-color:red;"><i class="fa fa-commenting-o fa-inverse fa-fw"></i></span>', ''),
(7, 'SMS', 'CONFIRMED', 'Confirmed', '<span class="btn" title="Confirmed by SMS" style="background-color:green;"><i class="fa fa-commenting-o fa-inverse fa-fw"></i></span>', ''),
(8, 'SMS', 'CALL', 'Callback Requested by Patient', '<span class="fa-stack fa-lg" title="Patient requests Office Call"><i class="fa fa-circle fa-stack-2x" style="color:red;"></i><i class="fa fa-flag fa-stack-1x fa-inverse"></i></span>', ''),
...
(14, 'AVM', 'SENT', 'AVM in process', '<span class="btn" title="AVM in process, no response" style="background-color:yellow;color:black;"><i class="fa fa-volume-control-phone fa-fw"></i></span>', ''),
(15, 'AVM', 'READ', 'AVM delivered', '<span class="btn" title="AVM completed - waiting for manual response" aria-label="AVM Delivered" style="background-color:#146abd;"><i class="fa fa-phone fa-fw" aria-hidden="true"></i></span>', ''),
(16, 'AVM', 'FAILURE', 'AVM: Message failed', '<span class="btn" title="AVM: Failed.  Check patient\'s phone numbers." style="background-color:red;"><i class="fa fa-phone fa-inverse fa-fw"></i></span>', ''),
(17, 'AVM', 'CONFIRMED', 'Confirmed', '<span class="btn" title="Confirmed by AVM" style="background-color:green;"><i class="fa fa-phone fa-inverse fa-fw"></i></span>', ''),
(18, 'AVM', 'CALL', 'Callback Requested by Patient', '<span class="fa-stack fa-lg" title="Patient requests Office Call"><i class="fa fa-circle fa-stack-2x" style="color:red;"></i><i class="fa fa-flag fa-stack-1x fa-inverse fa-fw"></i></span>', ''),
(19, 'AVM', 'Other', 'Extra text sent along...', '<span class="fa-stack fa-lg"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-terminal fa-fw fa-stack-1x fa-inverse"></i></span>', ''),
(20, 'AVM', 'STOP', 'Optout of AVM please', '<span class="btn btn-danger" title="OptOut of Voice Messaging. Demographics updated." aria-label="Optout AVM"><i class="fa fa-phone" aria-hidden="true"> STOP</i></span>', ''),
(21, 'EMAIL', 'ALLOWED', 'EMAIL:  allowed', '<span title="EMAIL is possible" class="fa fa-envelope-o fa-fw"></span>', ''),
(22, 'EMAIL', 'NotAllowed', 'EMAIL: not allowed', '<span class="fa-stack" title="EMAIL is not possible"><i class="fa fa-envelope-o fa-fw fa-stack-1x"></i><i class="fa fa-ban fa-stack-2x text-danger"></i></span>', ''),
(23, 'EMAIL', 'SCHEDULED', 'EMAIL: scheduled', '<span class=''btn scheduled'' title=''EMAIL scheduled''><i class="fa fa-envelope-o fa-fw"></i></span>', ''),
(24, 'EMAIL', 'SENT', 'EMAIL: sent', '<span class="btn" style="background-color:yellow;color:black;" title="EMAIL Message sent, not opened"><i class="fa fa-envelope-o fa-fw"></i></span>', ''),
(25, 'EMAIL', 'READ', 'EMAIL was opened/read', '<a class="btn" style="background-color:#146abd;" title="E-Mail was read/opened by patient" aria-label="Confirmed via email"><i class="fa fa-envelope-o fa-inverse fa-fw" aria-hidden="true"></i></a>', ''),
(26, 'EMAIL', 'FAILURE', 'EMAIL Message failed', '<span class="btn" title="EMAIL: Failed.  Check patient''s email address." style="background-color:red;"><i class="fa fa-envelope-o fa-inverse fa-fw"></i></span>', ''),
(27, 'EMAIL', 'CONFIRMED', 'EMAIL Confirmed', '<a class="btn btn-success" style="background-color: green;" title="Confirmed by E-Mail" aria-label="Confirmed via email"><i class="fa fa-envelope-o fa-fw" aria-hidden="true"></i></a>', ''),
(28, 'EMAIL', 'CALL', 'Callback Requested by Patient', '<span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x" style="color:red;"></i><i class="fa fa-flag fa-fw fa-stack-1x fa-inverse fa-fw"></i></span>', ''),
(29, 'EMAIL', 'Other', 'Extra text sent along...', '<span class="fa-stack fa-lg"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-terminal fa-fw fa-stack-1x fa-inverse fa-fw"></i></span>', ''),
(30, 'EMAIL', 'STOP', 'Optout of EMAIL please', '<span class="btn btn-danger" title="OptOut of EMAIL Messaging. Demographics updated." aria-label="Optout EMAIL"><i class="fa fa-envelope-o" aria-hidden="true"> STOP</i></span>', ''),
(31, 'POSTCARD', 'SENT', 'POSTCARD sent', '<span class="btn" title="Postcard Sent - in process" style="background-color:yellow;color:black"><i class="fa fa-image fa-fw"></i></span>', ''),
(32, 'POSTCARD', 'READ', 'e-POSTCARD delivered', '<a class="btn" style="background-color:#146abd;" title="e-Postcard was delivered" aria-label="Postcard Delivered"><i class="fa fa-image fa-fw" aria-hidden="true"></i></a>', ''),
(33, 'POSTCARD', 'FAILURE', 'e-POSTCARD failed', '<span class="fa-stack fa-lg" title="Delivery Failure - check Address for this patient"><i class="fa fa-image fa-fw fa-stack-1x"></i><i class="fa fa-ban fa-stack-2x text-danger"></i></span>', ''),
(34, 'POSTCARD', 'SCHEDULED', 'Postcard Campaign Event is scheduled.', '<span class="btn scheduled" title="Postcard Campaign Event is scheduled."><i class="fa fa-image fa-fw"></i></span>', '');
