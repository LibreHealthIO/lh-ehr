...
/*the purpose of this code is to get the 
  patient billing data in a formatted manner 
  and store it in a single variable $content_billing*/

$pdf->SetFont('dejavusans', '', 10);

$content_billing = '<span style="font-size:25px;font-family: Arial, sans-serif;">Billing Information:<br></span>';
if (count($ar['patient_encounter']) > 0) {
    $billings = array();
    $content_billing .= "<table>";
    $content_billing .= '<tr><td width="400"><b>Code</b></td><td><b>Fee</b></td></tr>';
    $total = 0.00;
    $copays = 0.00;
    ...
    $content_billing .= "<tr><td><b>Sub-Total</b></td><td>" . oeFormatMoney($total + abs($copays)) . "</td></tr>";
    $content_billing .= "<tr><td><b>Pid</b></td><td>" . oeFormatMoney(abs($copays)) . "</td></tr>";
    $content_billing .= "<tr><td><b>Total</b></td><td>" . oeFormatMoney($total) . "</td></tr>";
    $content_billing .= "</table>";
    $content_billing .= "<pre>";
    $content_billing .= "</pre>";
} 
