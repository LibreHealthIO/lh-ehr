...
/*the purpose of this code is to get the 
  patient demographics data in a formatted manner 
  and store it in a single variable $content_demo*/

$pdf->SetFont('dejavusans', '', 10);
            
$content_demo = '<span style="font-size:25px;font-family: Arial, sans-serif;">Patient Data:<br></span>';
